...
engine = import_module("photo_light_sculptor")
...
def reproduce_example(output_directory: str | Path) -> dict:
    ...
    return engine.sculpt_photo(INPUT / "workbench.jpg", output_directory, mode="focus", strength=1.0, subject_mask_path=INPUT / "vase-mask.png")
