...
def reproduce_case(case_name: str, output_directory: str | Path) -> dict:
    ...
    return engine.build_series([inputs/"source.png"]+[inputs/f"{name}.png" for name in ("animal","city","portrait") if name!=case_name],output,strategy="visual-rhythm",visual_review_confirmed=False)
