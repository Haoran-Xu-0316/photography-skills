...
def reproduce_example(output_directory: str | Path) -> dict:
    ...
    return engine.convert_photo_to_3d(INPUT / "workbench.jpg", output_directory, mode="parallax", depth_map_path=INPUT / "hand-authored-depth.png", allow_model_download=False, parallax_strength=0.012)
