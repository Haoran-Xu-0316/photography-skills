...
def reproduce_example(output_directory: str | Path) -> dict:
    ...
    return engine.redact_photo(INPUT / "fictional-label.png", output_directory, rectangles=[{"left": 70, "top": 560, "right": 510, "bottom": 700, "unit": "pixel", "label": "Fictional test label"}], manual_review_confirmed=False)
